...
class MainVC: UIViewController, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if let sections = controller.sections {
            let sectionInfo = sections[sections]
...
func generateTestData() {
    ...
    item1.price = 300
    item1.details = "But man, its so nice to be able to bloack out everyone with the noise canceling tech"

    let item2 = Item(context: context)
    item2.title = "Tesla Model S"
    item2.price = 110000
    item2.details = "Oh man, this is a beautiful car. And oneday, I will own it"
